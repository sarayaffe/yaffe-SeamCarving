...
class MinimalEnergySeamTest {
    ...
    void calculateMinSeam_vertical() {
        ...
        assertArrayEquals(expectedMinSeam, minimalEnergySeam.calculateMinSeam(verticalMinEnergies));
    }
    ...
    void calculateMinSeam_horizontal() {
        ...
        assertArrayEquals(expectedMinSeam, minimalEnergySeam.calculateMinSeam(horizontalMinEnergies));
    }
