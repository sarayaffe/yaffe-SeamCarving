...
class MinimalEnergiesTest {
    ...
    void calculateVerticalMinEnergies() {
        ...
        assertArrayEquals(expectedMinEnergies, minimalEnergies.getVerticalMinEnergies());
    ...
    void calculateHorizontalMinEnergies() {
        ...
        assertArrayEquals(expectedMinEnergies, minimalEnergies.getHorizontalMinEnergies());
    }
